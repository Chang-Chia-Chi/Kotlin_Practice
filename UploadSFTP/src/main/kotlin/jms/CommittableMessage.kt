...
sealed class CommittableMessage(
    ...
    ) : CommittableMessage(coAcknowledge),
        Message by inner {
        override fun acknowledge(): Unit = error("You must not call acknowledge directly. Please, call coAcknowledge.")
    }
