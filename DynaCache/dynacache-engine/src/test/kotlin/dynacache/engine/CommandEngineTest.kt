...
class CommandEngineTest {
    ...
    // The admission rule and the Zipf hit-ratio comparison moved to PartitionStoreTest (T72):
    // both are about which key the policy gives up, which is the store's question and not the
    // interpreter's.
