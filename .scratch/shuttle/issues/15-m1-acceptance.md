...
- [ ] One suite covers S1 to S26 end to end, each named by id
- [ ] S13 at 5,000 files of 10 MB: all DONE, in-flight never above parallelism, staging bounded, no skipped poll at the next tick
- [ ] Spec Sec 17 items 1 to 8 and 11 re-checked; each closed or left open with what is missing
