...
/**
 * What a task file's `cache:` name resolves to.
 *
 ...
 * `datasources`, `transforms` and `hooks` already have, and for the same reason: wiring is a host
 * obligation, and a framework that reached for a `SnapshotCache` on its own would need a container
 * this module deliberately does not boot.
 *
