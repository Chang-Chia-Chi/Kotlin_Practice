...
| P6 | [p6-review-fixes.md](p6-review-fixes.md) | T48 to T76 | review bugs closed at root cause, codec, versioned store, one inbound loop |
| P7 | [p7-performance.md](p7-performance.md) | T77 to T79 | the three benchmark anomalies fixed and re-measured |
